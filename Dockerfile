...
WORKDIR /content
CMD python -m md2cf --parent-id "${CONFLUENCE_PARENT_ID}" --minor-edit --only-changed --skip-empty --beautify-folders --collapse-single-pages --enable-relative-links /content
